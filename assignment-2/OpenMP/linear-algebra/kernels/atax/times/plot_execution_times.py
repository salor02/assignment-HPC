...
for line in lines:
    if line.startswith("OPTIMIZATION_") or line.startswith("SEQUENTIAL"):
        ...
        data[current_optimization] = {}  # Inizializza la struttura per l'ottimizzazione
    elif any(line.startswith(dataset) for dataset in datasets):
        # Riga con dataset e tempo
        # Esempio: "MINI      : 0.10673666"
        parts = line.split(":")
